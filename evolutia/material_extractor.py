...
class MaterialExtractor:
    ...
    def get_all_exercises(self, materials: List[Dict]) -> List[Dict]:
        ...
        for material in materials:
            # Optimización: Diccionario para búsqueda O(1) de soluciones
            # Preservamos comportamiento de "primera coincidencia" del break original
            solutions_dict = {}
