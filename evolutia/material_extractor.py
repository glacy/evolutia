...
class MaterialExtractor:
    ...
    def get_all_exercises(self, materials: List[Dict]) -> List[Dict]:
        ...
        for material in materials:
            # ⚡ Bolt Optimization: Replace O(N*M) nested loop with O(N) dict lookup.
            # Building the dict manually ensures we keep the first-match behavior of the original loop.
            solutions_dict = {}
